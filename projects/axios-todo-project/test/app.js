...
/***********************************************************************************/
/***********************************************************************************/
/******************** Make list items draggable and rearangable ********************/
/***********************************************************************************/
/***********************************************************************************/
...
function handleDrop(e) {
  ...
  // Don't do anything if dropping the same list-item we're dragging.
  if (dragSrcElement != this) {
    // Set the source list-item's HTML to the HTML of the list-item we dropped on.
...
function handleDragEnd(e) {
  ...
  /*[].forEach.call(allListItems, function (col) {
...
// const allListItems = document.querySelectorAll('#list .list-item');
// [].forEach.call(allListItems, addDnDHandlers);
